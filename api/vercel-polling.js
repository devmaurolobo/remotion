...
// Armazenamento em memória para jobs (em produção seria um banco)
const jobs = new Map();
...
app.get('/api/health', (req, res) => {
  res.json({
    status: 'OK',
    timestamp: new Date().toISOString(),
    service: 'Video Generator API (Polling System)',
    environment: process.env.NODE_ENV || 'development',
    message: 'API funcionando! Sistema de polling para renderização assíncrona.',
    template: 'teste.json',
    capabilities: [
